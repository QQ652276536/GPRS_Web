...
public class Base64XXX
{
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            String strs = "25800000D90000320157F13E06CAA2E6000E00005E53CE000E";
            System.out.println(encodeXXX(strs));

            byte[] bytesAAA = Base64.encodeBase64(strs.getBytes("UTF-8"));
            String enCode = new String(bytesAAA,"utf-8");
            System.out.println(enCode);


            String msg = URLDecoder.decode(strs,"GB2312");
    ...
    public static String encodeXXX(String srcData)
    {
    ...
    public static String decodeXXX(String srcData)
    {
        //检测元数据中“=”的个数，并将之去除
        int counter = 0;
        if (srcData.contains("="))
